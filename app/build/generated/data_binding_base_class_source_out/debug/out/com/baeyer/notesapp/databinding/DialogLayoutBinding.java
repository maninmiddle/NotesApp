...
package com.baeyer.notesapp.databinding;
...
public final class DialogLayoutBinding implements ViewBinding {
  ...
  private DialogLayoutBinding(@NonNull CardView rootView, @NonNull MaterialButton addNoteBtn,
      @NonNull EditText etName, @NonNull EditText etText) {
  ...
  public static DialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.addNoteBtn;
      MaterialButton addNoteBtn = ViewBindings.findChildViewById(rootView, id);
      if (addNoteBtn == null) {
        break missingId;
      }
      ...
      return new DialogLayoutBinding((CardView) rootView, addNoteBtn, etName, etText);
    }
