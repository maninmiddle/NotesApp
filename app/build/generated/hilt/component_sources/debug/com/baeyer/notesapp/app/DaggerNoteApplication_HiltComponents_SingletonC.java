...
import com.baeyer.notesapp.di.AppModule_ProvideAppDatabaseFactory;
import com.baeyer.notesapp.di.AppModule_ProvideApplicationContextFactory;
import com.baeyer.notesapp.di.AppModule_ProvideNoteDaoFactory;
import com.baeyer.notesapp.di.AppModule_ProvideNoteRepositoryFactory;
...
import com.baeyer.notesapp.presentation.main.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerNoteApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends NoteApplication_HiltComponents.ViewModelC {
    ...
    private AddNoteUseCase addNoteUseCase() {
      return new AddNoteUseCase(singletonCImpl.noteRepository());
    }

    private EditNoteUseCase editNoteUseCase() {
      return new EditNoteUseCase(singletonCImpl.noteRepository());
    }

    private GetNotesUseCase getNotesUseCase() {
      return new GetNotesUseCase(singletonCImpl.noteRepository());
    }

    private DeleteNoteUseCase deleteNoteUseCase() {
      return new DeleteNoteUseCase(singletonCImpl.noteRepository());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.baeyer.notesapp.presentation.main.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.baeyer.notesapp.presentation.main.MainViewModel 
          return (T) new MainViewModel(viewModelCImpl.addNoteUseCase(), viewModelCImpl.editNoteUseCase(), viewModelCImpl.getNotesUseCase(), viewModelCImpl.deleteNoteUseCase());
  ...
  private static final class SingletonCImpl extends NoteApplication_HiltComponents.SingletonC {
    ...
    private AppDatabase appDatabase() {
      return AppModule_ProvideAppDatabaseFactory.provideAppDatabase(provideApplicationContextProvider.get());
    }

    private NoteDao noteDao() {
      return AppModule_ProvideNoteDaoFactory.provideNoteDao(appDatabase());
    }

    private NoteRepository noteRepository() {
      return AppModule_ProvideNoteRepositoryFactory.provideNoteRepository(noteDao());
    }
